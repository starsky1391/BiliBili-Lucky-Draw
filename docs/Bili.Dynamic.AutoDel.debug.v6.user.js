// ==UserScript==
// @name         Bili.Dynamic.AutoDel.Debug.V6
// @namespace    https://github.com/
// @version      2026.09.03-debug-v6
...
(function() {
    ...
    const LOG_PREFIX = '[Bili.Dynamic.AutoDel.V6]';
    ...
    /**
     * 获取动态主体；列表项使用 orig，详情项直接使用自身
     * @param {object} data 动态信息
     * @returns 返回可供解析的动态主体
     */
    function getDynamicSource(data) {
    ...
    function getLotteryMarkers(data) {
        let source = getDynamicSource(data);
        if (source == null) {
            return [];
        }
