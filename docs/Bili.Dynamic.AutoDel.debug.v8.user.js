// ==UserScript==
// @name         Bili.Dynamic.AutoDel.Debug.V8
// @namespace    https://github.com/
// @version      2026.09.03-debug-v8
...
(function() {
    ...
    const LOG_PREFIX = '[Bili.Dynamic.AutoDel.V8]';
        ...
        for (let uid of unfollow_list) {
            try {
                ...
                debugLog('准备提交取关请求。', {
                    ...
                    has_csrf: csrf != null,
                    csrf_length: csrf == null ? 0 : csrf.length,
                    delay_ms: delay
                });
